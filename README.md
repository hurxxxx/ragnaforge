...
### **RTX 3090 GPU 테스트 결과**
- **처리 속도**: OpenAI 대비 **3-4배 빠름** (50페이지 문서 2.23초)
- **품질**: **25% 더 정확한** 한국어 유사도 측정 (0.4435 vs 0.3540)
- **비용**: **완전 무료** (OpenAI 대비 연간 수만 달러 절약)
...
### **처리량 비교**
- **KURE v1 (RTX 3090)**: 시간당 1,614개 문서
- **OpenAI Large**: 시간당 500개 문서
- **CPU 처리**: 시간당 32개 문서
