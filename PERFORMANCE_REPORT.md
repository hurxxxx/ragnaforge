...
| 비용 (50페이지) | $0.0000 | $0.0044 | $0.0008 | 로컬 vs API 호출 |
...
```
KURE v1:      로컬 처리 (전력비용만)
OpenAI Small: $240/월 (월 1000개 문서 기준)
OpenAI Large: $1,320/월 (월 1000개 문서 기준)
```
...
#### 월간 운영 비용 비교 (1,000개 문서 기준)
- KURE v1: 전력비용만 (약 $50-100)
- OpenAI Large: $1,320
- OpenAI Small: $240

#### 연간 비용 차이
- vs OpenAI Large: $15,840 차이
- vs OpenAI Small: $2,880 차이
